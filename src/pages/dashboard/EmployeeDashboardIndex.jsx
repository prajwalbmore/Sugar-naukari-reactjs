          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            >
              <div className="text-center">
                ...
                <div className="font-semibold">{t("Browse Jobs")}</div>
            ...
            >
              <div className="text-center">
                ...
                <div className="font-semibold">{t("My Applications")}</div>
                <div className="text-sm opacity-90">
            ...
            >
              <div className="text-center">
                ...
                <div className="font-semibold">{t("Update Profile")}</div>
                <div className="text-sm opacity-90">
                  {t("Enhance your resume")}
                </div>
              </div>
            </Link>
            ...
            >
              <div className="text-center">
                ...
                <div className="font-semibold">{t("Saved Jobs")}</div>
                <div className="text-sm opacity-90">{t("Your favorites")}</div>
              </div>
            </Link>
          </div>
        </div>
          ...
          <div className="lg:col-span-8 space-y-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-6 hover:shadow-xl transition-all duration-200">
                ...
                <div className="text-sm text-gray-600">{t("Applied Jobs")}</div>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-6 hover:shadow-xl transition-all duration-200">
                ...
                <div className="text-2xl font-bold text-gray-900 mb-1">
                  {data?.stats?.saved_jobs || 0}
                </div>
                <div className="text-sm text-gray-600">{t("Saved Jobs")}</div>
              </div>
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-6">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    <p className="text-sm text-gray-900">
                      {t("Applied to Senior Developer position")}
                    </p>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    <p className="text-sm text-gray-900">
                      {t("Profile viewed by")} TechCorp Inc.
                    </p>
            ...
            <div className="bg-gradient-to-br from-orange-400 to-red-500 rounded-xl shadow-lg text-white p-6">
              ...
              <p className="text-orange-100 mb-4">
                {t("Get notified when jobs matching your skills are posted")}
              </p>
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-8">
            <div>
              ...
              <p className="text-gray-600">
                {t("Based on your skills, experience, and preferences")}
              </p>
            </div>
            <Link
              to="/dashboard/jobs"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
            {data?.recommended_jobs?.slice(0, 6).map((job, index) => {
              ...
              const transformedJob = {
                _id: job.id,
                jobTitle: job.title,
                jobRole: job.type || "Role",
                exp_level: job.type || "Fresher",
                salary: job.salary,
              ...
              return (
                ...
                >
                  <JobCard job={transformedJob} refetch={refetch} t={t} />
                </div>
              );
            })}
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-gray-600">
                {t("Track all your job applications and their status")}
              </p>
            </div>
            <Link
              to="/dashboard/applications"
