...
const ModifiedSubscriptionCard = ({
  bgColor = "appcolor",
  textColor = "black",
  ...
  return (
    <div
      className={`bg-${bgColor} rounded-3xl px-6 py-6 w-[300px] shadow-lg text-${textColor} flex flex-col mx-auto`}
    >
...
export default ModifiedSubscriptionCard;
